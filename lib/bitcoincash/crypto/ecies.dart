...
class Ecies {
  ...
  ///
  List<int> AESEncrypt(List<int> messageBuffer, BCHPrivateKey senderPrivateKey,
  ...
  ///
  List<int> AESDecrypt(
      List<int> cipherText, BCHPrivateKey recipientPrivateKey) {
    ...
    final message = Uint8List.fromList(
        cipherText.sublist(0, cipherText.length - tagLength));

    final hmac = _calculateHmac(kM, message);
    final messageChecksum =
        cipherText.sublist(cipherText.length - tagLength, cipherText.length);
